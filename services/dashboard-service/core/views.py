...
SERVICE_DEFAULTS: dict[str, str] = {
    "company": "http://company-service:8000/api/companies/health/",
    "contract": "http://contract-service:8000/api/contracts/health/",
    "finance": "http://finance-service:8000/api/finance/health/",
    "space": "http://space-service:8000/api/spaces/health/",
    "booking": "http://booking-service:8000/api/bookings/health/",
    "inventory": "http://inventory-service:8000/api/inventory/health/",
    "ticket": "http://ticket-service:8000/api/tickets/health/",
    "document": "http://document-service:8000/api/documents/health/",
    "auth": "http://auth-service:8000/api/auth/health/",
}

METRIC_ENDPOINTS: dict[str, str] = {
    "company": "http://company-service:8000/api/companies/stats/",
    "finance": "http://finance-service:8000/api/finance/dashboard/",
    "ticket": "http://ticket-service:8000/api/tickets/",
}
...
class DashboardReportsView(APIView):
    ...
    def get(self, request: Request) -> Response:
        ...
        if report_type == "finance":
            ok, payload = _fetch_json(_env_url("METRICS", "finance", METRIC_ENDPOINTS["finance"]), headers)
